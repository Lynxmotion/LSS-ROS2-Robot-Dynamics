 ...
 * @ingroup Motion
 */
class Path_RoundedComposite2 : public Path
	{
		...
		Path_RoundedComposite2(Path_Composite* comp,double radius,double eqradius,RotationalInterpolation* orient, bool aggregate, int nrofpoints);
	...
	public:
		 ...
		 */
		Path_RoundedComposite2(double radius,double eqradius,RotationalInterpolation* orient, bool aggregate=true);
		...
		virtual ~Path_RoundedComposite2();
	};
